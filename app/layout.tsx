...
export const metadata: Metadata = {
  title: 'GPT-4o Language Translator',
          ...
          <nav className="container flex h-14 max-w-screen-2xl items-center justify-between">
            <Link href={'/'}>
              <h1 className="flex gap-2 items-center font-bold">
                ...
                <span>GPT-4o Language Translator</span>
              </h1>
            </Link>
            <div className="flex">
              <Button size={'icon'} variant={'ghost'} asChild>
                <Link href={'https://github.com/roberthgnz/gpt-4o-language-translator'} target="_blank">
              ...
              <Button size={'icon'} variant={'ghost'} asChild>
                <Link href={'https://twitter.com/roberthgnz'} target="_blank">
